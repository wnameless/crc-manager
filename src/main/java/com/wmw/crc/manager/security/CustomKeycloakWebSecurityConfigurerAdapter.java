 ...
 */
package com.wmw.crc.manager.security;
 ...
 * instance secured by Keycloak. This implementation allows customization by
 * overriding methods.
 *
...
public abstract class CustomKeycloakWebSecurityConfigurerAdapter extends
  ...
  protected AdapterDeploymentContext adapterDeploymentContext()
    ...
    if (keycloakConfigResolver != null) {
      ...
      factoryBean =
          new AdapterDeploymentContextFactoryBean(keycloakConfigFileResource);
    }
  ...
  protected KeycloakAuthenticationProcessingFilter keycloakAuthenticationProcessingFilter()
    ...
    KeycloakAuthenticationProcessingFilter filter =
        new KeycloakAuthenticationProcessingFilter(authenticationManagerBean());
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().requireCsrfProtectionMatcher(keycloakCsrfRequestMatcher()).and()
        .sessionManagement()
